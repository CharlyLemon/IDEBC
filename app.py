...
# ── Imports de módulos propios — compatible con Streamlit Cloud ────────────────
...
from src.data_fetcher import fetch_all_indicators
from src.calculator import calculate_idec, DIMENSION_WEIGHTS, SIGNAL_SCALE
