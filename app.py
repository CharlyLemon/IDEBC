...
if not hist:
    ...
    if ind_sel and opciones_disp:
        ...
        if df_hist.empty:
            ...
            # Color según dirección del indicador
            dir_map = {k: d["direction"] for k, fn, name, u, dim, d_val, mn, mx, w
                       in [(i[0],)+i[1:] for i in INDICATORS]
                       for k2, d in [("k", {"direction": i[5]})] if k == k2}
